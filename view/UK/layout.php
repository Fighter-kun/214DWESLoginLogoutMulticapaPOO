...
<html lang="es">
    ...
    <body>
        <header class="text-center">
            <h1>App LoginLogoutMulticapaPOO</h1>
        </header>
        <main>
            <div class="container">
                <div class="row">
        ...
        <footer class="position-fixed bottom-0 end-0">
            <div class="row text-center">
                ...
                <div class="footer-item">
                    <a href="../214DWESProyectoDWES/indexProyectoDWES.html" style="color: white; text-decoration: none; background-color: #666;">Start</a>
                </div>
                <div class="footer-item">
